  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        slate: "border-transparent bg-slate-100 text-slate-800 dark:bg-slate-800/30 dark:text-slate-300",
        purple: "border-transparent bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300",
        gray: "border-transparent bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-300",
